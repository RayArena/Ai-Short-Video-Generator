...
function SelectStyle({onUserSelect}) {
    ...
    return (
        <div className="mt-7">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-5 gap-5 mt-3 ">
                {styleOptions.map((item, index) => (
                    <div key={index} className={`relative max-w-90 hover:scale-110 transition-all cursor-pointer rounded-xl
